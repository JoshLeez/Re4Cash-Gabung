  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/kelola-lapak-penjualan-pengelola/"
          element={<PengelolaKelolaLapakPenjualan />}
        />
        <Route path="/keranjang" element={<Keranjang />} />
        <Route
          path="/kelola-lapak-penjualan-pengelola/tambah"
          element={<PengelolaKelolaLapakPenjualanTambah />}
        />
        <Route
          path="/kelola-lapak-penjualan-pengelola/edit"
          element={<PengelolaKelolaLapakPenjualanEdit />}
        />
        <Route
          path="/kelola-lapak-pencarian-pengelola/"
          element={<PengelolaKelolaLapakPencarian />}
        />
        <Route
          path="/kelola-lapak-pencarian-pengelola/tambah"
          element={<PengelolaKelolaLapakPencarianTambah />}
        />
        <Route
          path="/kelola-lapak-pencarian-pengelola/edit"
          element={<PengelolaKelolaLapakPencarianEdit />}
        />
